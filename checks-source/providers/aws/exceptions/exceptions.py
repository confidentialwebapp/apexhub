from apexhub.exceptions.exceptions import APEX HubException


# Exceptions codes from 1000 to 1999 are reserved for AWS exceptions
class AWSBaseException(APEX HubException):
    ...
    AWS_ERROR_CODES = {
        ...
        (1002, "AWSNoCredentialsError"): {
            ...
            "remediation": "Verify that AWS credentials are properly set up, please visit https://apexhub-lime.vercel.app/projects/apexhub-open-source/en/latest/tutorials/aws/authentication/ and https://docs.aws.amazon.com/cli/v1/userguide/cli-chap-configure.html",
        },
        ...
        (1012, "AWSAssumeRoleError"): {
            ...
            "remediation": "Check the AWS assume role configuration and ensure it is properly set up, please visit https://apexhub-lime.vercel.app/projects/apexhub-open-source/en/latest/tutorials/aws/role-assumption/ and https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html#iam-term-role-session-name",
        },
