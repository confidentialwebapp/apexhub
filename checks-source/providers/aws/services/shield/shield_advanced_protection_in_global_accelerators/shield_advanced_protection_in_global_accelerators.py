...
from apexhub.providers.aws.services.globalaccelerator.globalaccelerator_client import (
    globalaccelerator_client,
)
from apexhub.providers.aws.services.shield.shield_client import shield_client
