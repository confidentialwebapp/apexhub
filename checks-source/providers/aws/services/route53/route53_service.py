...
from apexhub.lib.scan_filters.scan_filters import is_resource_filtered
from apexhub.providers.aws.lib.service.service import AWSService
...
class Route53(AWSService):
    ...
    def _get_all_region_elastic_ips(self):
        ...
        When running APEX Hub with --region, ec2_client.elastic_ips is scoped
