...
from apexhub.providers.alibabacloud.config import (
    ALIBABACLOUD_DEFAULT_REGION,
    ALIBABACLOUD_REGIONS,
    ROLE_SESSION_NAME,
)
from apexhub.providers.alibabacloud.exceptions.exceptions import (
    AlibabaCloudInvalidCredentialsError,
    AlibabaCloudNoCredentialsError,
    AlibabaCloudSetUpSessionError,
)
from apexhub.providers.alibabacloud.lib.mutelist.mutelist import AlibabaCloudMutelist
from apexhub.providers.alibabacloud.models import (
...
class AlibabacloudProvider(Provider):
        ...
        Usage:
            - Alibaba Cloud Credentials SDK is used, so we follow their credential setup process:
                ...
                - To create a new Alibaba Cloud provider object:
                    ...
                    - alibabacloud = AlibabacloudProvider(role_arn="acs:ram::...:role/APEX HubRole")
                    - alibabacloud = AlibabacloudProvider(ecs_ram_role="ECS-APEX Hub-Role")
    ...
    def get_regions_to_audit(self, regions: list = None) -> list:
        ...
        """
        from apexhub.providers.alibabacloud.models import AlibabaCloudRegion
    ...
    def test_connection(
        ...
        Examples:
            ...
            >>> AlibabacloudProvider.test_connection(
                    role_arn="acs:ram::123456789012:role/APEX HubRole",
