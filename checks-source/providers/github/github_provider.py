...
from apexhub.providers.github.exceptions.exceptions import (
...
from apexhub.providers.github.lib.mutelist.mutelist import GithubMutelist
from apexhub.providers.github.models import (
...
class GithubProvider(Provider):
    ...
    def __init__(
        ...
        # Mute GitHub library logs to reduce noise since it is already handled by the APEX Hub logger
