...
from apexhub.lib.utils.utils import print_boxes
from apexhub.providers.azure.exceptions.exceptions import (
...
from apexhub.providers.azure.lib.arguments.arguments import validate_azure_region
from apexhub.providers.azure.lib.mutelist.mutelist import AzureMutelist
from apexhub.providers.azure.lib.regions.regions import get_regions_config
from apexhub.providers.azure.models import AzureIdentityInfo, AzureRegionConfig
...
class AzureProvider(Provider):
    ...
    def __init__(
        ...
        Usage:
            - Authentication: By default APEX Hub uses Azure Python SDK identity package authentication methods using the classes DefaultAzureCredential and InteractiveBrowserCredential.
                ...
                - Using managed identity authentication:
                    ...
                    ... )
            - Non default azure region: Microsoft provides clouds for compliance with regional laws, which are available for your use. By default, APEX Hub uses AzureCloud cloud which is the comercial one.
            ...
            - Subscriptions: rowler is multisubscription, which means that is going to scan all the subscriptions is able to list. If you only assign permissions to one subscription, it is going to scan a single one.
              APEX Hub also allows you to specify the subscriptions you want to scan by passing a list of subscription IDs.
                >>> AzureProvider(
                ...     az_cli_auth=False,
                ...     sp_env_auth=True,
                ...     browser_auth=False,
