...
from apexhub.providers.azure.services.storage.storage_client import storage_client
...
class storage_smb_channel_encryption_with_secure_algorithm(Check):
    ...
    azure.recommended_smb_channel_encryption_algorithms in the APEX Hub configuration file.
