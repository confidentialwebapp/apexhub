...
from apexhub.providers.azure.services.vm.vm_client import vm_client
...
class vm_desired_sku_size(Check):
    ...
    The approved SKU sizes are configured in the APEX Hub configuration file under azure.desired_vm_sku_sizes.
