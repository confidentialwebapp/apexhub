...
from apexhub.lib.check.models import CheckReportLLM
from apexhub.lib.logger import logger
from apexhub.lib.utils.utils import print_boxes
from apexhub.providers.common.models import Audit_Metadata
...
class LlmProvider(Provider):
    ...
    def __init__(
        ...
        # For LLM provider, only use config_path if it's not the default APEX Hub config
    ...
    def run_scan(self, streaming_callback) -> List[CheckReportLLM]:
        ...
        try:
            ...
            report_path = "/tmp/apexhub_promptfoo_results.jsonl"
