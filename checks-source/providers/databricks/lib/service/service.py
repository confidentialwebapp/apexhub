...
from apexhub.providers.databricks.exceptions.exceptions import (
    DatabricksAPIError,
...
class DatabricksService:
    """Base class for Databricks services: shared provider context and HTTP client."""
    ...
    def _get(self, path: str, params: dict = None) -> dict:
        """Make a rate-limit-aware GET request to the Databricks API.

        Args:
            path: API path (e.g., "/api/2.1/clusters/list").
        ...
        Raises:
            DatabricksRateLimitError: If rate limited after retries.
            DatabricksAPIError: If the API returns an error.
        """
        if params is None:
            params = {}
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                if response.status_code == 429:
                    ...
                    if attempt < max_retries:
                        ...
                        continue
                    raise DatabricksRateLimitError(
                        file=__file__,
            ...
            except DatabricksRateLimitError:
                raise
    ...
    def _paginate(self, path: str, key: str = None, params: dict = None) -> list:
        """Paginate through a Databricks list endpoint.
