...
from apexhub.providers.googleworkspace.exceptions.exceptions import (
...
from apexhub.providers.googleworkspace.lib.mutelist.mutelist import (
    GoogleWorkspaceMutelist,
)
from apexhub.providers.googleworkspace.models import (
...
class GoogleworkspaceProvider(Provider):
    ...
    def test_connection(
        ...
        Examples:
            ...
            ...     delegated_user="apexhub-reader@company.com"
            ... )
