...
from apexhub.providers.atlassian.exceptions.exceptions import (
    AtlassianAPIError,
...
class AtlassianService:
    """Base class for Atlassian Cloud services: shared provider context and HTTP client."""
    ...
    def _get(self, path: str, params: dict = None) -> dict:
        """Make a rate-limit-aware GET request to the Atlassian Cloud API.

        Args:
            path: API path (e.g., "/admin/v1/orgs").
        ...
        Raises:
            AtlassianRateLimitError: If rate limited after retries.
            AtlassianAPIError: If the API returns an error.
        """
        if params is None:
            params = {}
        ...
        for attempt in range(max_retries + 1):
            ...
            except AtlassianRateLimitError:
                raise
    ...
    def _paginate(self, path: str, key: str = None, params: dict = None) -> list:
        """Paginate through a Atlassian Cloud list endpoint.
