...
from apexhub.providers.oraclecloud.config import OCI_DEFAULT_CONFIG_FILE, OCI_REGIONS
...
def init_parser(self):
    ...
    oci_regions_subparser.add_argument(
        ...
        "-f",
        nargs="+",
        help="OCI region to run APEX Hub against. If not specified, all subscribed regions will be audited",
