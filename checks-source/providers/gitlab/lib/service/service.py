...
from apexhub.providers.gitlab.exceptions.exceptions import (
    GitLabAPIError,
...
class GitLabService:
    """Base class for GitLab services: shared provider context and HTTP client."""
    ...
    def _get(self, path: str, params: dict = None) -> dict:
        """Make a rate-limit-aware GET request to the GitLab API.
        ...
        Raises:
            GitLabRateLimitError: If rate limited after retries.
    ...
    def _paginate(self, path: str, key: str = None, params: dict = None) -> list:
        """Paginate through a GitLab list endpoint.
