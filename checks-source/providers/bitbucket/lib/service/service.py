...
from apexhub.providers.bitbucket.exceptions.exceptions import (
    BitbucketAPIError,
...
class BitbucketService:
    """Base class for Bitbucket services: shared provider context and HTTP client."""
    ...
    def _get(self, path: str, params: dict = None) -> dict:
        """Make a rate-limit-aware GET request to the Bitbucket API.
        ...
        Raises:
            BitbucketRateLimitError: If rate limited after retries.
            BitbucketAPIError: If the API returns an error.
        """
        if params is None:
            params = {}
        ...
        for attempt in range(max_retries + 1):
            ...
            except BitbucketRateLimitError:
                raise
    ...
    def _paginate(self, path: str, key: str = None, params: dict = None) -> list:
        """Paginate through a Bitbucket list endpoint.
