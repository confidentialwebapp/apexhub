...
from apexhub.providers.salesforce.exceptions.exceptions import (
    SalesforceAPIError,
...
class SalesforceService:
    """Base class for Salesforce services: shared provider context and HTTP client."""
    ...
    def _get(self, path: str, params: dict = None) -> dict:
        """Make a rate-limit-aware GET request to the Salesforce API.

        Args:
            path: API path (e.g., "/services/data/v61.0/query").
        ...
        Raises:
            SalesforceRateLimitError: If rate limited after retries.
            SalesforceAPIError: If the API returns an error.
        """
        if params is None:
            params = {}
    ...
    def _paginate(self, path: str, key: str = None, params: dict = None) -> list:
        """Paginate through a Salesforce list endpoint.
