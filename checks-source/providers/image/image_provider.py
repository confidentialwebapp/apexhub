...
from apexhub.providers.image.lib.arguments.arguments import (
    IMAGE_CONFIG_SCANNERS_CHOICES,
    SCANNERS_CHOICES,
    SEVERITY_CHOICES,
)
from apexhub.providers.image.lib.registry.dockerhub_adapter import DockerHubAdapter
from apexhub.providers.image.lib.registry.factory import create_registry_adapter
...
class ImageProvider(Provider):
    ...
    `trivy image` command and converts the output to APEX Hub's finding format.
    """
    ...
    def _process_finding(
        ...
        try:
            ...
            # Convert Trivy severity to APEX Hub severity (lowercase, map UNKNOWN to informational)
