def init_parser(self):
    ...
    gcp_organization_subparser.add_argument(
        ...
        help="GCP Organization ID to be scanned by APEX Hub",
    )
    # Projects
    ...
    gcp_projects_subparser.add_argument(
        ...
        nargs="+",
        default=[],
        help="GCP Project IDs to be scanned by APEX Hub",
    )
    gcp_projects_subparser.add_argument(
        "--excluded-project-id",
        ...
        nargs="+",
        default=[],
        help="Excluded GCP Project IDs to be scanned by APEX Hub",
    )
    gcp_projects_subparser.add_argument(
        "--list-project-id",
        "--list-project-ids",
        action="store_true",
        help="List available project IDs in Google Cloud which can be scanned by APEX Hub",
    )
    # GCP Config
