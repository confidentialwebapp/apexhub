...
from apexhub.providers.okta.models import OktaSession

if TYPE_CHECKING:
    from apexhub.providers.okta.okta_provider import OktaProvider
...
class OktaService:
    ...
    synchronous like the other APEX Hub providers. The SDK auto-refreshes
